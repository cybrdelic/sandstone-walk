...
Open `http://localhost:8000` in a current WebGL2 browser. The active compressed mesh/bake buffers total approximately **__ASSET_MB__ MB**. A self-contained HTML is available in [Releases](../../releases/latest), or build it locally:
...
| Current scene | Count |
|---|---:|
| Triangles | __TRIANGLES__ |
| Vertices | __VERTICES__ |
| Material/bake mesh groups | 9 |
| Closed rock components | __ROCKS__ |
| Native irradiance sample locations | __SITES__ |
...
New native mesh SHA-256: `__MESH_HASH__`.
