...
#pragma once
const V ATM_LO(-1000,-30,0.f),ATM_HI(1000,2500,150);
double atmosphereSigma(){return sceneStyle==2?.0045:(sceneStyle==1?.0009:.00075);}
double atmosphereScale(){return sceneStyle==2?9.0:180.0;}
#define ATM_SIGMA (atmosphereSigma())
#define ATM_SCALE_HEIGHT (atmosphereScale())
